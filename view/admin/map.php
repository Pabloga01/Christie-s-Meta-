        ...
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!-- MAP DATA-->
                        <div class="map-data m-b-40 mt-4">
...
<script src="view/admin/vendor/vector-map/jquery.vmap.js"></script>
<script src="view/admin/vendor/vector-map/jquery.vmap.min.js"></script>
<script src="view/admin/vendor/vector-map/jquery.vmap.sampledata.js"></script>
<script src="view/admin/vendor/vector-map/jquery.vmap.world.js"></script>
<script src="view/admin/vendor/vector-map/jquery.vmap.brazil.js"></script>
<script src="view/admin/vendor/vector-map/jquery.vmap.europe.js"></script>
<script src="view/admin/vendor/vector-map/jquery.vmap.france.js"></script>
<script src="view/admin/vendor/vector-map/jquery.vmap.germany.js"></script>
<script src="view/admin/vendor/vector-map/jquery.vmap.russia.js"></script>
<script src="view/admin/vendor/vector-map/jquery.vmap.usa.js"></script>
